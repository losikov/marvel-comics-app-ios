...
class ComicsDetailsCollectionViewLoadingMoreCell: UICollectionViewCell {
    static let cellIdentifier = "ComicsDetailsCollectionViewLoadingMoreCellIdentifer"
...
extension ComicsDetailsCollectionViewLoadingMoreCell {
    private func setupViews() {
        ...
        // Activity Indicator
        activityIndicator.color = .marvelLabelText
